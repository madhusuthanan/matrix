...
jQuery(document).ready(function($){
	...
	$(".main_menu a.homeservice").click(function(){
	...
	$(".main_menu a.page2").click(function( ){
	...
	$(".main_menu a.homeportfolio").click(function(){
	...
	$(".main_menu a.hometestimonial").click(function(){
	...
	$(".main_menu a.page4").click(function(){    
    $('#menu-container .homepage').fadeOut(1000, function(){
        $('#menu-container .testimonial').fadeIn(1000);
	    });
		return false
	});
	$(".main_menu a.homeabout").click(function(){
	...
	$(".main_menu a.page5").click(function(){    
    $('#menu-container .homepage').fadeOut(1000, function(){
	...
	$(".main_menu a.homecontact").click(function(){
	...
	$(".main_menu a.page6").click(function(){    
    $('#menu-container .homepage').fadeOut(1000, function(){
